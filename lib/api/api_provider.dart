...
import 'package:horecah/api/base_provider.dart';
...
class ApiProvider extends BaseProvider {
  ...
  Future<Response> uploadImage(File image, String ref, String field, int id) async{
    ...
    final form = FormData({
      'files': MultipartFile(image.path, 
                            ...
                            contentType: (extension == 'jpg' || extension == 'png') ? 'image/jpeg' : 'application/pdf'),
      'field' : field,
      'ref'   : ref,
      'refId' : id
    });

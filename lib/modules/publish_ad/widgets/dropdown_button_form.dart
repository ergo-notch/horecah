...
class _DropDownButtonFormPeopleTypeState extends State<DropDownButtonFormPeopleType> {
  var controller = Get.find<PublishAdController>();
...
class _DropDownButtonFormCondizioneState extends State<DropDownButtonFormCondizione> {
  var controller = Get.find<PublishAdController>();
